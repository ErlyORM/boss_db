            ...
            case mysql:get_result_rows(MysqlRes) of
                ...
                [Row] ->
                    ...
                    case boss_record_lib:ensure_loaded(Type) of
                        true -> activate_record(Row, Columns, Type, model);
...
find(Pid, Type, Conditions, Max, Skip, Sort, SortOrder, Capture) when is_atom(Type), is_list(Conditions),
