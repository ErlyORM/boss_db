...
-spec created_news_process_inner_2(_,_,_,_,[any()],'undefined' | fun(),_) -> any().
...
-spec delete_news_watchers_inner(binary() | maybe_improper_list(binary() | maybe_improper_list(any(),binary() | []) | char(),binary() | []),_,_,[any()],_) -> any().
-spec delete_news_watchers_inner_1(binary() | maybe_improper_list(binary() | maybe_improper_list(any(),binary() | []) | char(),binary() | []),_,_,_,_,[any()],'undefined' | fun(),_) -> any().
...
-spec news_update_controller_inner_2(_,_,_,[any()],_,atom(),_,_,string(),_) -> any().
-spec news_update_controller_inner_3(_,_,_,atom(),_,string(),_,_,_,[any()],'undefined' | fun(),_) -> any().
